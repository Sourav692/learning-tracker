...
const PHASES = [
  ...
  },
  {
    id: "p3",
    tag: "03",
    name: "Agents — foundations & frameworks",
    window: "late Aug – Sep",
    thesis: "Build one capable agent from first principles: the reasoning loop and tool use, the workflow patterns, then the SDKs and frameworks you'll actually build with.",
    modules: [
      {
        id: "m8",
  ...
  },
  {
    id: "p3b",
    tag: "04",
    name: "Agents — memory, MCP & multi-agent",
    window: "Sep – Oct",
    thesis: "Turn a single agent into a system: give it persistent memory, connect it to the world through MCP, compose multiple agents, and master the deep-agent harness (Claude Code).",
    modules: [
      {
        id: "m10m",
        title: "Memory & state",
      ...
      },
      {
        ...
        why: "The scaffolding around the model — tools, memory, sub-agents, context — is where long-horizon reliability is won or lost. It composes everything in the agent arc before it.",
        signals: ["agent", "ship"],
        tag: null,
        critical: true,
        topics: [
        ...
        build: "A deep-research agent with sub-agents + memory over a domain — long-horizon, durable, with disciplined context management.",
        resources: ["LangChain Deep Agents docs", "Deep Agents vs Claude Agent SDK comparison"],
      },
    ],
  },
  {
    ...
    window: "Oct",
    thesis: "Claude Code is Anthropic's flagship agentic coding harness — for an FDE targeting Anthropic, mastering it is table stakes, and knowing the wider tool landscape is how you advise clients credibly. It sits here because it composes everything in the agent arc.",
    modules: [
      {
        id: "mcc",
        title: "Claude Code — operator mastery",
        why: "You'll use it daily and clients will ask you to justify it. Go past the Claude Certified Architect cert into real operator depth — configuration, extensibility, and headless automation.",
        signals: ["agent", "ship"],
        tag: null,
        critical: true,
        topics: [
          "Claude Code core: CLAUDE.md, slash commands, the permission model",
          "Skills, subagents & hooks — the extensibility surface",
          "MCP servers inside Claude Code; wiring in tools & data",
          "Headless / programmatic use via the Claude Agent SDK (deeper than m9s)",
          "Claude Code in CI & automation; non-interactive runs",
          "Cowork & computer use as the non-developer surface (awareness)",
          "Operator depth past your Claude Certified Architect cert",
        ],
        build: "Ship a real Claude Code setup for a PS-style workflow — a CLAUDE.md, custom commands, a skill, and a subagent pipeline — then run it headless in CI.",
        projects: [{ title: "Realtime Source Code Analyzer", url: "https://www.krishnaik.in/project/realtime-source-code-analyzer", note: "Repo-indexing code agent — the coding-agent pattern, hands-on." }],
        resources: ["Claude Code docs", "Claude Agent SDK docs", "Anthropic engineering — Claude Code patterns"],
      },
      {
        id: "mct",
        title: "The AI coding-tool landscape",
        why: "FDEs get asked 'how does this compare to Cursor?' constantly. Know the field well enough to position Claude Code honestly — not to adopt all of it.",
        signals: ["discovery", "ship"],
        tag: null,
        critical: false,
        topics: [
          "IDE-native: Cursor, Windsurf, GitHub Copilot",
          "CLI / terminal agents: Aider, Codex, Cline, Roo Code",
          "How they differ: harness design, context handling, autonomy, price",
          "Autonomous coding agents & SWE-bench-style benchmarks",
          "Agentic coding workflow: spec → plan → implement → test → review",
          "Positioning Claude Code vs the field in a client conversation",
        ],
        build: "Run the same non-trivial task through Claude Code and two others (say Cursor + Aider); write the honest comparison you'd give a client.",
        resources: ["SWE-bench leaderboard", "Vendor docs: Cursor / Aider / Windsurf"],
      },
    ],
  },
  {
    ...
    modules: [
      {
        ...
        resources: ["Your Phase 07 mock-loop notes", "FDE interview writeups"],
      },
      {
        id: "m21",
        ...
        <main style={styles.main}>
          ...
          <footer style={styles.footer}>
            <p style={styles.footNote}>
              ...
              bulk of your calendar on Phases 03–07. The single highest-leverage artifact you can produce
              this year is the <b style={{ color: C.teal }}>eval harness</b> in Phase 06 — build it early
              and let it pull the capstones behind it. Phases 08–09 aren't more theory — they're reps,
